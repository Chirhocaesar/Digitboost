			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Standorte-Sitemap - DigitBoost Solutions</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML-Sitemap - DigitBoost Solutions</title>
					</xsl:otherwise>
				</xsl:choose>
...
Served from: digitboostsolutions.com @ 2025-08-28 00:29:47 by W3 Total Cache
-->